...
export default function sitemap(): MetadataRoute.Sitemap {
  const pages = [
    ...
    { path: "/ki-kompetenz-nachweis", priority: 0.8 },
    { path: "/art-4-ai-act-erklaert", priority: 0.8 },
    { path: "/ki-fuehrerschein-vergleich", priority: 0.8 },
    { path: "/chatgpt-schulung-mitarbeiter", priority: 0.8 },
    { path: "/ki-schulung-mitarbeiter", priority: 0.8 },
